...
fdr_plot_s1 = metrics_figs1 %>% ggplot(aes(x = as.factor(correlation), y = fdr, fill = as.factor(correlation))) + 
                           geom_violin() +
                           ylim(0,1) + 
                           ylab("False Discovery Proportion") +
...
tpr_plot_s1 = metrics_figs1 %>% ggplot(aes(x = as.factor(correlation), y = tpr, fill = as.factor(correlation))) + 
  geom_violin() +
  ylim(0,1) + 
  ylab("Empirical Power") +
  xlab(expression(sigma[corr])) + 
...
# Create the violin plot
figs6 = ggplot(p_evaluate_long, aes(x = as.factor(variable), y = value, fill = as.factor(variable))) +
  geom_boxplot(outlier.shape = NA) +
  labs(
    x = "Proportion of invalid surrogates",
    y = "P-value",
